...
<header class="relative z-20 flex flex-col">
	<div class="mx-auto flex w-full max-w-[1400px] items-center justify-between p-4 py-6">
		<a href="/" class="flex items-center gap-4">
			...
			<h1 class="font-semibold"><span class="text-black">Dusun Druju Tegal</span></h1>
		</a>
		<button
		...
		<nav class="hidden items-center gap-4 md:flex lg:gap-6">
			<a href="#product" class="cursor-pointer font-semibold text-black duration-200 hover:text-indigo-400"
				>Product</a
			>
			<a href="#review" class="cursor-pointer font-semibold text-black duration-200 hover:text-indigo-400"
				>Review</a
			>
